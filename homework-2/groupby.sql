...
SELECT order_id, customer_id, freight, ship_country FROM public.orders
...
SELECT country, COUNT(*) FROM public.suppliers
GROUP BY country
ORDER BY COUNT(*) DESC
...
SELECT ship_country, SUM(freight) FROM public.orders
